                ...
                <ul>
                    ...
                    <li data-index="rs-24" data-transition="fade" data-slotamount="default" data-easein="default"
                        ...
                        <div class="tp-caption contrive-ken-title1 tp-resizeme rs-parallaxlevel-0"
                             ...
                             style="z-index: 5; white-space: nowrap;">ZAPEWNIAMY
                        </div>
                    ...
                    <li data-index="rs-25" data-transition="fade" data-slotamount="default" data-easein="default"
                        ...
                        <div class="tp-caption contrive-ken-title1 tp-resizeme rs-parallaxlevel-0"
                             ...
                             data-splitout="none"
                             data-responsive_offset="on"
                             style="z-index: 5; white-space: nowrap;">NA RYNKU
                        </div>
    ...
    <div class="contrive-row-fw contrive-fw-no-padding">
        <div class="contrive-container">
            <div class="contrive-row">
                ...
                <div data-aos="fade-down" data-aos-easing="linear" data-aos-duration="600"
                     class="contrive-col-3 hvr-float">
                ...
                <div class="contrive-row">
                    @foreach($partners as $partner)
                        <div class="contrive-col-2">
                            <div data-aos="fade-down" data-aos-easing="linear" data-aos-duration="600" class="aligncenter">
                                <a href="{{ $partner->url }}" title=""><img src="{{ asset("storage/{$partner->image}") }}" alt="{{ $partner->name }}" title="{{ $partner->name }}"></a>
                            </div>
                            <div class="contrive-topmargin-30"></div>
                        </div>
                    @endforeach
