        ...
        <div class="contrive-container">
            ...
            <div class="contrive-row">
                ...
                <div class="contrive-col-9">
                    ...
                    <nav class="main-nav">
                        <ul>
                            <li class="current_page_item"> <a href="{{ route('index') }}" title=""> Strona Główna </a></li>
                            <li class="current_page_item"> <a href="{{ route('gallery') }}" title=""> Galeria </a></li>
                            <li class="current_page_item"> <a href="{{ route('services') }}" title=""> Usługi </a></li>
                            <li class="current_page_item"> <a href="{{ route('work') }}" title=""> Praca </a></li>
                            <li class="current_page_item"> <a href="{{ route('contact') }}" title=""> Kontakt </a></li>
                        </ul>
                    </nav>
                    <!-- *** MAIN NAVIGATION END *** -->
                </div>
